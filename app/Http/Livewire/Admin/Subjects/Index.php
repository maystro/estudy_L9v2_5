...
//            'lectures' => ['key'=>'levels.id' , 'foreign_key'=>'lectures.level_id'],
        ...
        'columns' => [
            ...
            'created_at' => [
                'name' => 'subjects.created_at',
                'nameAs' => 'subject_created_at',
                'label' => 'تاريخ الإضافة',
                'type' => 'datetime',
                'visible' => true,
                'filtered' => false,
    ...
    protected $LivewireTemplate = 'livewire.admin.subjects.index';
    protected $LivewireCreateView = 'admin.subjects.form';
    protected $LivewireEditView = 'admin.subjects.form';

    public $editFormModal = '#subject-form-modal';
    public $createFormModal = '#subject-form-modal';
