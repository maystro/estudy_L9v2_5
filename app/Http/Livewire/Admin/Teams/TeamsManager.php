...
//            'lectures' => ['key'=>'levels.id' , 'foreign_key'=>'lectures.level_id'],
    ...
    protected $LivewireTemplate = 'livewire.admin.teams.teams-manager';
    protected $LivewireCreateView = 'admin.teams.team-form';
    protected $LivewireEditView = 'admin.teams.team-form';

    public $editFormModal = '#team-form-modal';
    public $createFormModal = '#team-form-modal';
...
//            'class' => 'bg-success']);
    ...
    public function getCellContent($row, $column, $key): string
    {
        switch ($key) {
            case 'users_count':
                $count = TeamUser::query()->where('team_id','=',$row[$this->config->primaryKey])->count();
